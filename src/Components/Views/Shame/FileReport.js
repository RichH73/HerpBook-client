...
const incidentDescription = 'Please include as many details as possible. DO NOT use foul language in your description. Do not use hyperlinks or email addresses.'
  ...
  render() {
    ...
    <React.Fragment>
        <div className='shame-file-report-opening-paragraph'>
            ...
            reviewed prior to being listed on HerpBook.</p>
            <p>
